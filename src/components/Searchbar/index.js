...
const Searchbar = () => {
    const [searchColor, setSearchColor] = useState('#e5e5e5');

    const handleMouseEnter = () => {
        setSearchColor('#b5b5b5')
    }

    const handleMouseLeave = () => {
        setSearchColor('#e5e5e5')
    }
    
    return (
        <div className=''>
            <svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="searchIcon" onMouseEnter={() => handleMouseEnter()} onMouseLeave={() => handleMouseLeave()}>
