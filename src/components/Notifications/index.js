...
const Notifications = () => {
    const [bellColor, setBellColor] = useState('#e5e5e5');
    ...
    return (
        <div className="notifications relative">
            <span className='notificationPill h-[10px] w-[10px] rounded bg-red text-white absolute right-0'>
            </span>
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="notificationBell" onMouseEnter={() => handleMouseEnter()} onMouseLeave={() => handleMouseLeave()}>
